...
A reusable, headless Angular 20 locale picker. It renders a globe
...
effect. The `locale-picker-status` element restores that, in visible
...
Import the optional `LocalePickerIcon` directive if you want typed
`let-` variables:
