/*
    ...
    picker in a top utility banner. The banner uses sibling-button
    ...
    "locale-picker-list" — that hook now belongs to the helper's own
    <ul role="listbox">, and reusing it here would make consumer
    popup-positioning CSS apply to this inline banner group too.

    `className="… locale-picker-hidden"` must hide the helper COMPLETELY
...
import { LocalePicker, bcp47LocaleTag } from "../locale-picker.component";
  ...
  template: `
    <header class="utility-banner" aria-label="Site utilities">
      ...
      <lily-locale-picker
        ...
        className="utility-banner-languages locale-picker-hidden"
      />
