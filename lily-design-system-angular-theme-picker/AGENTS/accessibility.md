...
Angular-flavoured view of the contract; the canonical contract is
...
- **Wrapping the host in a div to "scope" the radio group.** The
  `<fieldset role="radiogroup">` is already the group. Adding a
  wrapper duplicates the semantic.
