...
| Helper | Purpose |
| ------ | ------- |
| [`lily-design-system-angular-theme-select`](./lily-design-system-angular-theme-select/) | Pick a visual theme; dynamic CSS load + `data-theme` swap, optional persistence. |
