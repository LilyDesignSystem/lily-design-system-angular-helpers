# Lily Design System — Angular 20 Helpers — Specification

Spec-driven plan and task list for the Angular 20 helpers catalog. This file is
...
The helpers catalog ships a small set of opinionated, reusable Angular 20
...
- SSR / prerender safety; framework-idiomatic Angular 20 source.
...
| Helper | Purpose |
| ------ | ------- |
| [`lily-design-system-angular-theme-chooser`](../lily-design-system-angular-theme-chooser/) | Pick a visual theme; dynamic CSS load + `data-theme` swap, optional persistence. |
...
- Component source: `{kebab}.component.ts`, `{kebab}.component.spec.ts`.
...
- Headless sibling: [`lily-design-system-angular-headless`](../../lily-design-system-angular-headless/).
