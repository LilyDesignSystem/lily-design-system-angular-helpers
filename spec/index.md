...
| Helper                                                                                     | Purpose                                                                          |
| ------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------- |
| [`@lilydesignsystem/angular-theme-picker`](../lily-design-system-angular-theme-picker/)   | Pick a visual theme; dynamic CSS load + `data-theme` swap, optional persistence. |
...
- Headless sibling: [`@lilydesignsystem/angular-headless`](../../lily-design-system-angular-headless/).
