...
`@lilydesignsystem/angular-share-picker`. Each file is a runnable
...
| 3   | [`custom-glyph.component.ts`](./custom-glyph.component.ts) | Projecting an `<ng-template>` to replace the default icon — including with visible text. |
